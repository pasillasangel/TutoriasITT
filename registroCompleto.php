...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Tutorias ITT - Registro Completo</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Registro Completado</h2>
                    <h4 class="section-subheading text-muted">¡Ya puedes inicar sesi&oacute;n!</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
